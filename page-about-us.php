    ...
    <div class="container mx-auto">
        <div class="mx-10">
            <div class="aboutUs_heading__wrapper pt-24 pb-1">
                <h1 class="thentwrktheme_page__heading text-white font-prompt ml-14">About</h1>
            </div>
        </div>
    </div>
</section>
...
<section id="aboutUs_content" class="my-10 h-screen">
    <div class="container mx-auto">
        <div class="mx-10">
            <?php if( have_rows('about_us_page') ): ?>
                <?php while( have_rows('about_us_page') ): the_row(); 
                    ...
                    <div class="grid grid-cols-2 gap-10 py-2">
                        <!-- Left side -->
                        <div class="text-white thentwrkTheme_paragraph font-jost my-10">
                            <div class="aboutUs_content__wrapper">
                                <?php echo $aboutUsContentText; ?>
                            </div>
                            <!-- Get in touch carrds -->
                            <div class="aboutUs_getInTouch__wrapper my-24">
                                <!-- First card -->
                                <div class="flex justify-start items-center aboutUs_getInTouch__cards px-10 py-5 bg-darkBrown w-9/12 mt-6">
                                    <div class="">
